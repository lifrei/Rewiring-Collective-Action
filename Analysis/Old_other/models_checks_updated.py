...
#baseline run node2vec is 34 mins w 5 runs, 400 nodes, t:20k, 6 min for 1 run w 700 nodes, 19min for 700 30k


#alt is 27 mins with t = 30k, 4 min for 700 nodes, 9mins for 700 nodes and t:30k
#6 mins with less walk length
