...
#from models_checks import plot_network
#import network_stats

#%% testing and building networks

G = DPAH(n=500, f_m=0.5, d=0.02, h_MM=0.8, h_mm=0.8, plo_M=2.0, plo_m=2.0, seed=42)
G.generate()
...
G = PATCH(n=500, f_m=0.5, h_MM=0.5, h_mm=0.5, k =4, tc= 0.5, seed=42)
G.generate()
#viz.plot_graph(G, edge_arrows = False, edge_width = 1, arrow_size =10, cell_size = 3, node_size = 50)
#print(Homophily.infer_homophily_values(G))
print(G.infer_homophily_values())
print(network_stats.infer_homophily_values(G, G.calculate_fraction_of_minority()))
#print(G.infer_homophily_values())
